...
class ControllerBatch_f extends Controller {

	public function index()
	{
		//
		$batch_f = DB::connection('sqlsrv')->select(DB::raw("SELECT * FROM batch_fs ORDER BY batch_id asc"));
		return view('batch_f.index', compact('batch_f'));
	}

	public function create()
	{
		//
		return view('batch_f.create');
	}
	...
	public function insert(Request $request)
	{
		...
		try {
			...
			return view('batch_f.error');
		}
		
		return Redirect::to('/batch_f');

	}

	public function edit($id) {

		$batch_f = Batch_fs::findOrFail($id);		
		return view('batch_f.edit', compact('batch_f'));
	}
