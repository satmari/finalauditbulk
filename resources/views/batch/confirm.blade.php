        ...
        <div class="text-center">
            	...
            	<div class="row">
            		<table class="table">
                    	<thead>
                        	<tr>
                        		<td>Total Defects</td>
                        		<td>Total <b>Rejected</b> Defects</td>
            ...
            <div class="panel panel-default">
            	<div class="row">
            		<br>
				  <div class="col-md-4">
				  	<a href="{{url('/batch/accept/'.$batchid->id)}}" class="btn btn-success btn-lg">Accept</a>
                  </div>
				  <div class="col-md-4">
				  	<a href="{{url('/batch/acceptwithreservetion/'.$batchid->id)}}" class="btn btn-info btn-lg">Accept with reservation</a>
				  </div>
				  <div class="col-md-4">
				  	<a href="{{url('/batch/reject/'.$batchid->id)}}" class="btn btn-danger btn-lg">Reject</a>
				  </div>
				  	<br>
				</div>
				<br>
			...
			<div class="panel panel-info">
				...
				<div class="row">
				  <div class="col-md-6">
				  	<a href="{{url('/batch/suspend/'.$batchid->id)}}" class="btn btn-default btn-lg">Suspend</a>
				  </div>
				  <div class="col-md-6">
				  	<a href="{{url('#')}}" class="btn btn-danger btn-lg">Delete</a>
				  </div>
				</div>
				<br>
            </div>
