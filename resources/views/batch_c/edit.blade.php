	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				...
				<br>
					{!! Form::model($batch_c , ['method' => 'POST', 'url' => 'batch_c/'.$batch_c->id /*, 'class' => 'form-inline'*/]) !!}
					...
					{!! Form::open(['method'=>'POST', 'url'=>'/batch_c/delete/'.$batch_c->id]) !!}
				...
				<div class="panel-body">
					<div class="">
						<a href="{{url('/batch_c')}}" class="btn btn-default">Back</a>
					</div>
				</div>
