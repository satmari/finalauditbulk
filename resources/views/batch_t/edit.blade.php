	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				...
				<br>
					{!! Form::model($batch_t , ['method' => 'POST', 'url' => 'batch_t/'.$batch_t->id /*, 'class' => 'form-inline'*/]) !!}
					...
					{!! Form::open(['method'=>'POST', 'url'=>'/batch_t/delete/'.$batch_t->id]) !!}
				...
				<div class="panel-body">
					<div class="">
						<a href="{{url('/batch_t')}}" class="btn btn-default">Back</a>
					</div>
				</div>
