	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				...
				<br>
					{!! Form::model($batch_c , ['method' => 'POST', 'url' => 'batch_c_bulk/'.$batch_c->id /*, 'class' => 'form-inline'*/]) !!}

					<div class="panel-body">
						
						{!! Form::hidden('batch_id', $batch_c->batch_id, ['class' => 'form-control']) !!}
					...
					{!! Form::open(['method'=>'POST', 'url'=>'/batch_c_bulk/delete/'.$batch_c->id]) !!}
					{!! Form::hidden('id', $batch_c->id, ['class' => 'form-control']) !!}
				...
				<div class="panel-body">
					<div class="">
						<a href="{{url('/batch_c_bulk')}}" class="btn btn-default">Back</a>
					</div>
				</div>
