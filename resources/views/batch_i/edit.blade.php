	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				...
				<br>
					{!! Form::model($batch_i , ['method' => 'POST', 'url' => 'batch_i/'.$batch_i->id /*, 'class' => 'form-inline'*/]) !!}
					...
					{!! Form::open(['method'=>'POST', 'url'=>'/batch_i/delete/'.$batch_i->id]) !!}
				...
				<div class="panel-body">
					<div class="">
						<a href="{{url('/batch_i')}}" class="btn btn-default">Back</a>
					</div>
				</div>
