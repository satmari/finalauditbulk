                    ...
                    -->
                        ...
                        @foreach ($defects as $req)
                            <tr>
                                ...
                                <td><a href="{{ url('/defect_bulk/delete/'.$req->id) }}" class="btn btn-danger btn-xs center-block">Delete</a></td>
                            </tr>
                        @endforeach
                        </tbody> 
                    </table>               
            ...
            <div class="col-md-2">
              <div class="panel panel-default">
                <div class="panel-heading">Options</div>
                  ...
                  @foreach ($garment as $req)
                  <div class="row">
                    <a href="{{url('/defect_bulk_new/'.$req->garment_name)}}" class="btn btn-info side-button"><br>New Defect</a>
                  </div>
                  @endforeach
                  @foreach ($batch as $req)
                  <div class="row">
                    <a href="{{ url('/garment_bulk/by_batch/'.$req->batch_name) }}" class="btn btn-warning side-button"><br>Back</a>
                  </div>
                  @endforeach
              </div>  
            </div>
