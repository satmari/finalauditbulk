	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				...
				<br>
					{!! Form::model($batch_f , ['method' => 'POST', 'url' => 'batch_f/'.$batch_f->id /*, 'class' => 'form-inline'*/]) !!}
					...
					{!! Form::open(['method'=>'POST', 'url'=>'/batch_f/delete/'.$batch_f->id]) !!}
				...
				<div class="panel-body">
					<div class="">
						<a href="{{url('/batch_f')}}" class="btn btn-default">Back</a>
					</div>
				</div>
